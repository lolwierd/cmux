...
final class MainWindowCommandPaletteSupplementalCatalog {
    ...
    private func appendSidebarCommands(
        ...
        let matchesTerminal = UserDefaults.standard.bool(forKey: SidebarAppearanceSupport.userDefaultsKey)
        appendCommand(
            to: &commands,
            rank: &rank,
            ...
            UserDefaults.standard.set(!matchesTerminal, forKey: SidebarAppearanceSupport.userDefaultsKey)
        }
    ...
    private func appendWorkspaceCommands(
        ...
        appendCommand(
            ...
            subtitle: workspaceSubtitle,
            shortcutHint: KeyboardShortcutSettings.shortcutIfBound(for: .resetWorkspaceColor)?.displayString,
